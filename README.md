...
📡 𝐆𝐏𝐒 𝐋𝐎𝐂𝐀𝐓𝐈𝐎𝐍
Receive GPS coordinates from devices that have location sharing enabled and display their latest shared position.

🗺️ 𝐋𝐈𝐕𝐄 𝐌𝐀𝐏
Open an authorized device's shared position on an interactive map and quickly understand where it was last reported.

🕐 𝐋𝐎𝐂𝐀𝐓𝐈𝐎𝐍 𝐇𝐈𝐒𝐓𝐎𝐑𝐘
Keep a record of previously shared locations, including timestamps, so authorized users can review movement history.

🟢 𝐃𝐄𝐕𝐈𝐂𝐄 𝐒𝐓𝐀𝐓𝐔𝐒
Check whether an authorized device is currently connected, offline, or has recently sent a location update.
...
📜 /history — View previously shared locations.
